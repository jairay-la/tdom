        ...
        try:
            ...
            if os.path.exists(default_path):
                ...
                if raw_data is not None:
                    self.data = self.calculate_z_scores(raw_data)
                else:
                    self.show_error_message("Failed to load data properly")
            else:
                self.show_error_message("Default data file not found.")
        except Exception as e:
            self.show_error_message(f"Error loading initial data: {str(e)}")
